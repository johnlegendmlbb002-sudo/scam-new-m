...
export default function BuyFlowPage() {
  ...
  /* ================= GAME CONFIG ================= */
  const isMLBB = slug?.toLowerCase().includes("mlbb") || slug?.toLowerCase().includes("mobile-legends") || slug?.toLowerCase().includes("mobile-legens") || slug?.toLowerCase().includes("weeklymonthly-bundle261");
