...
export default function QueryTab() {
  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
          <motion.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            className="rounded-3xl border border-[var(--border)] bg-[var(--card)] p-5 sm:p-6 shadow-lg relative overflow-hidden group"
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="h-8 w-8 rounded-xl bg-[var(--accent)]/10 flex items-center justify-center text-[var(--accent)]">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full h-24 p-3 rounded-xl border border-[var(--border)] bg-[var(--background)] 
                             focus:ring-2 focus:ring-[var(--accent)]/20 outline-none transition-all
              ...
              <button
                ...
                className="w-full py-3.5 rounded-xl bg-[var(--accent)] text-white font-bold uppercase tracking-wider text-xs
            ...
            <div className="grid grid-cols-1 gap-3">
              {SUPPORT_CONFIG.contacts.items.map((item, idx) => (
                <motion.a
                  ...
                  className="group relative p-3 rounded-2xl border border-[var(--border)] bg-[var(--card)]/50 
                             hover:bg-[var(--card)] hover:border-[var(--accent)]/30 transition-all 
                             flex items-center gap-3 shadow-sm"
                >
                  <div className={`p-2.5 rounded-xl bg-[var(--accent)]/10 text-[var(--accent)] text-lg transition-all duration-300`}>
                    {ICON_MAP[item.icon]}
                  </div>

                  <div className="flex-1 min-w-0">
                    <p className="text-[9px] font-bold uppercase tracking-wider text-[var(--muted)] mb-0.5">{item.title}</p>
                    <p className="text-xs font-bold text-[var(--foreground)] truncate font-mono">
                      {item.value}
                    </p>
                  </div>
                </motion.a>
      ...
      <div className="space-y-4 mt-12 pt-8 border-t border-[var(--border)]/30">
        <div className="flex items-center gap-2 mb-2">
          <div className="h-7 w-7 rounded-lg bg-orange-500/10 flex items-center justify-center text-orange-500">
            <FiInfo className="text-base" />
          </div>
          <h3 className="text-lg font-bold italic tracking-tight uppercase">Frequently Asked Questions</h3>
        </div>
